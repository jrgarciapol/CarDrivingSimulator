...
CAR_KEYS = {
    ...
    "CAMERA_HEIGHT_COCKPIT", "CAMERA_FORWARD_COCKPIT", "CAMERA_SIDE_COCKPIT",
    "CAMERA_HEIGHT_HIGH", "CAMERA_BACK_HIGH", "CAMERA_PITCH_HIGH",
    "CAMERA_ORBIT_HIGH", "CAMERA_HEIGHT_PLAN", "CAMERA_BACK_PLAN",
    "CAMERA_PITCH_PLAN", "CAMERA_ISO_METROS", "CAMERA_ISO_PITCH",
    "CAMERA_ISO_YAW", "CAMERA_ISO_AHEAD",
